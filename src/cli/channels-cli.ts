    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["orionclaw channels list", "List configured channels and auth profiles."],
          ["orionclaw channels status --probe", "Run channel status checks and probes."],
          [
            "orionclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["orionclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.orionclaw.local/cli/channels",
        )}\n`,
    );
