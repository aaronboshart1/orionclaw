    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["orionclaw directory self --channel slack", "Show the connected account identity."],
          [
            'orionclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["orionclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "orionclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.orionclaw.local/cli/directory",
        )}\n`,
    )
    .action(() => {
