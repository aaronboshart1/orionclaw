...
export const DEFAULT_SANDBOX_IMAGE = "orionclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "orionclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "orionclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "orionclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "orionclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "orionclaw-sandbox-browser";
