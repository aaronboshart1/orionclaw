...
const CLEANUP_STATE_KEY = Symbol.for("orionclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("orionclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("orionclaw.sessionWriteLockWatchdogState");
