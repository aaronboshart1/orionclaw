...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    ...
    "Mirror: https://docs.orionclaw.local",
    "Source: https://github.com/orionclaw/orionclaw",
    "Community: https://discord.com/invite/clawd",
    "Find new skills: https://clawhub.com",
    "For OpenClaw behavior, commands, config, or architecture: consult local docs first.",
    "When diagnosing issues, run `orionclaw status` yourself when possible; only ask the user if you lack access (e.g., sandboxed).",
    "",
  ];
}
...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "If unsure, ask the user to run `orionclaw help` (or `orionclaw gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
