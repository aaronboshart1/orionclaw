 ...
 * a hint.
 *
 * See: https://github.com/orionclaw/orionclaw/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "orionclaw configure". ' +
    "See: https://docs.orionclaw.local/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "orionclaw configure". ' +
    "See: https://docs.orionclaw.local/providers/vllm",
};
