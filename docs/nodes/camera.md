...
OrionClaw supports **camera capture** for agent workflows:
...
```bash
orionclaw nodes camera snap --node <id>               # default: both front + back (2 MEDIA lines)
orionclaw nodes camera snap --node <id> --facing front
orionclaw nodes camera clip --node <id> --duration 3000
orionclaw nodes camera clip --node <id> --no-audio
```
...
```bash
orionclaw nodes camera list --node <id>            # list camera ids
orionclaw nodes camera snap --node <id>            # prints MEDIA:<path>
orionclaw nodes camera snap --node <id> --max-width 1280
orionclaw nodes camera snap --node <id> --delay-ms 2000
orionclaw nodes camera snap --node <id> --device-id <id>
orionclaw nodes camera clip --node <id> --duration 10s          # prints MEDIA:<path>
orionclaw nodes camera clip --node <id> --duration-ms 3000      # prints MEDIA:<path> (legacy flag)
orionclaw nodes camera clip --node <id> --device-id <id>
orionclaw nodes camera clip --node <id> --no-audio
```

Notes:

- `orionclaw nodes camera snap` defaults to `maxWidth=1600` unless overridden.
...
```bash
orionclaw nodes screen record --node <id> --duration 10s --fps 15   # prints MEDIA:<path>
```
