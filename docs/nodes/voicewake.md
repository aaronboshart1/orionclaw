...
OrionClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.orionclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["orionclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
