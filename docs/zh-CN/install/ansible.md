...
summary: 使用 Ansible、Tailscale VPN 和防火墙隔离进行自动化、加固的 OrionClaw 安装
title: Ansible
x-i18n:
...
将 OrionClaw 部署到生产服务器的推荐方式是通过 **[openclaw-ansible](https://github.com/aaronboshart1/orionclaw-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/aaronboshart1/orionclaw-ansible](https://github.com/aaronboshart1/orionclaw-ansible)**
>
...
Ansible 安装程序设置 OrionClaw 为手动更新。标准更新流程参见[更新](/install/updating)。
...
- [安全架构](https://github.com/aaronboshart1/orionclaw-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/aaronboshart1/orionclaw-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/aaronboshart1/orionclaw-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [openclaw-ansible](https://github.com/aaronboshart1/orionclaw-ansible) — 完整部署指南
