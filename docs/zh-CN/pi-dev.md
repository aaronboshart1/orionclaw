...
本指南总结了在 OrionClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 OrionClaw 状态目录下。默认为 `~/.orionclaw`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.orionclaw.local/testing
- https://docs.orionclaw.local/start/getting-started
