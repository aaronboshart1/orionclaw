---
summary: "CLI reference for `orionclaw onboard` (interactive onboarding wizard)"
read_when:
...
```bash
orionclaw onboard
orionclaw onboard --flow quickstart
orionclaw onboard --flow manual
orionclaw onboard --mode remote --remote-url wss://gateway-host:18789
```
...
- Fastest first chat: `orionclaw dashboard` (Control UI, no channel setup).
