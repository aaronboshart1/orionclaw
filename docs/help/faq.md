---
summary: "Frequently asked questions about OrionClaw setup, configuration, and usage"
read_when:
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up OrionClaw?](#whats-the-recommended-way-to-install-and-set-up-openclaw)
  ...
  - [I can't access docs.orionclaw.local (SSL error). What now?](#i-cant-access-docsopenclawai-ssl-error-what-now)
  ...
  - [How do I install OrionClaw on Linux?](#how-do-i-install-openclaw-on-linux)
  - [How do I install OrionClaw on a VPS?](#how-do-i-install-openclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask OrionClaw to update itself?](#can-i-ask-openclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run OrionClaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different OrionClaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run OrionClaw on a dedicated machine?](#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run OrionClaw in a VM and what are the requirements](#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
- [What is OrionClaw?](#what-is-openclaw)
  - [What is OrionClaw, in one paragraph?](#what-is-openclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for OrionClaw](#what-are-the-top-five-everyday-use-cases-for-openclaw)
  - [Can OrionClaw help with lead gen outreach ads and blogs for a SaaS](#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can OrionClaw run tasks on a schedule or continuously in the background?](#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with OrionClaw saved locally?](#is-all-data-used-with-openclaw-saved-locally)
  - [Where does OrionClaw store its data?](#where-does-openclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall OrionClaw?](#how-do-i-completely-uninstall-openclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the OrionClaw browser run headless?](#can-the-openclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two OrionClaw instances talk to each other (local + VPS)?](#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does OrionClaw load environment variables?](#how-does-openclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of OrionClaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset OrionClaw but keep it installed?](#how-do-i-completely-reset-openclaw-but-keep-it-installed)
  ...
  - [Why doesn't OrionClaw reply in a group?](#why-doesnt-openclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do OrionClaw, Flawd, and Krill use for models?](#what-do-openclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `orionclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-orionclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `orionclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-orionclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run OrionClaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart OrionClaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
  ...
  - [ELI5: `orionclaw gateway restart` vs `orionclaw gateway`](#eli5-orionclaw-gateway-restart-vs-orionclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose OrionClaw to inbound DMs?](#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
```bash
curl -fsSL https://orionclaw.local/install.sh | bash -s -- --install-method git
```

This installs OrionClaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/aaronboshart1/orionclaw/issues](https://github.com/aaronboshart1/orionclaw/issues)
[https://github.com/aaronboshart1/orionclaw/pulls](https://github.com/aaronboshart1/orionclaw/pulls)
...
- `orionclaw status`: quick snapshot of gateway/agent health + basic config.
- `orionclaw models status`: checks provider auth + model availability.
- `orionclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `orionclaw status --all`, `orionclaw logs --follow`,
`orionclaw gateway status`, `orionclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up OrionClaw
...
If you don't have a global install yet, run it via `pnpm orionclaw onboard`.
...
- Retrieve it from the gateway host: `orionclaw config get gateway.auth.token` (or generate one: `orionclaw doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `orionclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `orionclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install OrionClaw on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.orionclaw`) from the old machine.
3. Copy your workspace (default: `~/.orionclaw/workspace`).
4. Run `orionclaw doctor` and restart the Gateway service.
...
under `~/.orionclaw/` (for example `~/.orionclaw/agents/<agentId>/sessions/`).
...
[https://github.com/aaronboshart1/orionclaw/blob/main/CHANGELOG.md](https://github.com/aaronboshart1/orionclaw/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.orionclaw.local SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.orionclaw.local` via Xfinity
Advanced Security. Disable it or allowlist `docs.orionclaw.local`, then retry. More
...
[https://github.com/aaronboshart1/orionclaw/tree/main/docs](https://github.com/aaronboshart1/orionclaw/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://orionclaw.local/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://orionclaw.local/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://orionclaw.local/install.ps1](https://orionclaw.local/install.ps1)
...
```bash
curl -fsSL https://orionclaw.local/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://orionclaw.local/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://orionclaw.local/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://orionclaw.local/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```
...
If you still reproduce this on latest OrionClaw, track/report it in:
- [Issue #30640](https://github.com/aaronboshart1/orionclaw/issues/30640)
...
### How do I install OrionClaw on Linux
...
### How do I install OrionClaw on a VPS
...
### Can I ask OrionClaw to update itself
...
`orionclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run OrionClaw with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `orionclaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `orionclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `orionclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. OrionClaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so OrionClaw can keep replying while a provider is rate-limited.
...
OrionClaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. OrionClaw fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `orionclaw.json`.

Steps:

1. Enable the plugin: `orionclaw plugins enable google-gemini-cli-auth`
2. Login: `orionclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. OrionClaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. OrionClaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run OrionClaw can I connect it to my MacBook Pro
...
- Use `orionclaw nodes status` / `orionclaw nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but OrionClaw authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `orionclaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different OrionClaw instances
...
If you run OrionClaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the OrionClaw code install. Your state
(`~/.orionclaw`) and workspace (`~/.orionclaw/workspace`) stay untouched.
...
**OrionClaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run OrionClaw on a dedicated machine
...
OrionClaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run OrionClaw in a VM and what are the requirements
...
### What is OrionClaw in one paragraph

OrionClaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

OrionClaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for OrionClaw
...
### Can OrionClaw help with lead gen outreach ads and blogs for a SaaS
...
OrionClaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

OrionClaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use OrionClaw when you
...
Showcase: [https://orionclaw.local/showcase](https://orionclaw.local/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.orionclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.orionclaw/orionclaw.json`). Precedence is `<workspace>/skills` > `~/.orionclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.orionclaw/orionclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.orionclaw/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which OrionClaw treats as `<workspace>/skills`.
...
### Can OrionClaw run tasks on a schedule or continuously in the background
...
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. OrionClaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.orionclaw/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "orionclaw": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured OrionClaw workspace); OrionClaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.orionclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
OrionClaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

OrionClaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, OrionClaw auto-selects a provider when it
...
configured and present, OrionClaw
prefers `local`.
...
### Is all data used with OrionClaw saved locally

No - **OrionClaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.orionclaw` + your workspace directory).
...
### Where does OrionClaw store its data

Everything lives under `$OPENCLAW_STATE_DIR` (default: `~/.orionclaw`):

| Path                                                            | Purpose                                                            |
| --------------------------------------------------------------- | ------------------------------------------------------------------ |
| `$OPENCLAW_STATE_DIR/orionclaw.json`                             | Main config (JSON5)                                                |
...
Legacy single-agent path: `~/.orionclaw/agent/*` (migrated by `orionclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.orionclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.orionclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.orionclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.orionclaw/skills`).

Default workspace is `~/.orionclaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.orionclaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.orionclaw` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall OrionClaw
...
`workspace` to the repo root. The OrionClaw repo is just source code; keep the
...
OrionClaw reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.orionclaw/orionclaw.json`):

```
$OPENCLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.orionclaw/workspace`).
...
OrionClaw enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `orionclaw doctor --generate-gateway-token`.
...
key. **Recommended:** run `orionclaw configure --section web` to store it in
...
- Daemons read env vars from `~/.orionclaw/.env` (or the service environment).
...
### Can the OrionClaw browser run headless
...
- Gateway is running: `orionclaw gateway status`
- Gateway health: `orionclaw status`
- Channel health: `orionclaw channels status`
...
### Can two OrionClaw instances talk to each other local VPS
...
`orionclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
orionclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.orionclaw/orionclaw.json`).
- If you have no backup, re-run `orionclaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `orionclaw config set` for small changes.
- Use `orionclaw configure` for interactive edits.
...
```bash
orionclaw gateway --tailscale serve
```
...
### How does OrionClaw load environment variables

OrionClaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.orionclaw/.env` (aka `$OPENCLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.orionclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`orionclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means OrionClaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.orionclaw/.env`:
...
### Is there a way to make a team of OrionClaw instances one CEO and many agents
...
### How do I completely reset OrionClaw but keep it installed
...
- If you used profiles (`--profile` / `OPENCLAW_PROFILE`), reset each state dir (defaults are `~/.orionclaw-<profile>`).
- Dev reset: `orionclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), OrionClaw skips the heartbeat run to save API calls.
...
No. OrionClaw runs on **your own account**, so if you're in the group, OrionClaw can see it.
...
### Why doesn't OrionClaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.orionclaw/agents/<agentId>/sessions/`.
...
- Use `orionclaw doctor` to spot stray workspaces and profile mismatches.
...
OrionClaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, OrionClaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `orionclaw models set ...` (updates just model config)
- `orionclaw configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.orionclaw/orionclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `orionclaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do OrionClaw, Flawd, and Krill use for models

- **OrionClaw + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. OrionClaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.orionclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `orionclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so OrionClaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.orionclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.orionclaw/agent/*` (migrated by `orionclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.orionclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `orionclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `orionclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `orionclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.orionclaw/.env` on the **gateway host**.
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), OrionClaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: OrionClaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
OrionClaw uses provider-prefixed IDs like:
...
OrionClaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `orionclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.
...
### Why does orionclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `orionclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does orionclaw gateway status show Config cli and Config service different
...
OrionClaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `orionclaw gateway --port <port>`.

### How do I run OrionClaw in remote mode client connects to a Gateway elsewhere
...
- `orionclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `orionclaw dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `orionclaw doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPENCLAW_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `orionclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `orionclaw --profile <name> …` per instance (auto-creates `~/.orionclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `orionclaw --profile <name> gateway install`.

Profiles also suffix service names (`ai.openclaw.<profile>`; legacy `com.openclaw.*`, `orionclaw-gateway-<profile>.service`, `OrionClaw Gateway (<profile>)`).
...
- macOS: `$OPENCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.orionclaw/logs/...`; profiles use `~/.orionclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u orionclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "OrionClaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `orionclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart OrionClaw
...
1. Is the Gateway running? `orionclaw gateway status`
2. Is the Gateway healthy? `orionclaw status`
3. Does the UI have the right token? `orionclaw dashboard`
...
```bash
orionclaw channels status
orionclaw channels logs --channel telegram
```
...
```bash
orionclaw gateway stop
orionclaw gateway start
```
...
### ELI5 orionclaw gateway restart vs orionclaw gateway

- `orionclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `orionclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `orionclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [OrionClaw assistant setup](/start/openclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
orionclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose OrionClaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `orionclaw pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `orionclaw pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `orionclaw doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. OrionClaw only replies to chats it receives or to explicit sends you trigger.
...
OrionClaw blocks **cross-provider** messaging by default. If a tool call is bound
