...
read_when:
  - You want to place an outbound voice call from OrionClaw
...
Voice calls for OrionClaw via a plugin. Supports outbound notifications and
...
- Use `orionclaw voicecall ...` or the `voice_call` tool
...
```bash
openclaw voicecall call --to "+15555550123" --message "Hello from OrionClaw"
