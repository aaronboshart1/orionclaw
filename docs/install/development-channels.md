...
OrionClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OrionClaw also aligns
the install method:
...
When you switch channels with `orionclaw update`, OrionClaw also syncs plugin sources:
