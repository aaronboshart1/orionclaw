---
summary: "Use Qianfan's unified API to access many models in OrionClaw"
read_when:
...
3. OrionClaw installed on your system
...
4. Copy the API key for use with OrionClaw

## CLI setup

```bash
orionclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OrionClaw Configuration](/gateway/configuration)
