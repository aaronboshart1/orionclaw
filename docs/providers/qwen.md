---
summary: "Use Qwen OAuth (free tier) in OrionClaw"
read_when:
  - You want to use Qwen with OrionClaw
...
If you already logged in with the Qwen Code CLI, OrionClaw will sync credentials
