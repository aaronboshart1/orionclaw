...
You can point OrionClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OrionClaw
...
- [Anthropic provider](/providers/anthropic) - Native OrionClaw integration with Claude setup-token or API keys
