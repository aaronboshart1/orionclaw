---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OrionClaw"
read_when:
  - You want Xiaomi MiMo models in OrionClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OrionClaw uses
