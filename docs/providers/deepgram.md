...
Deepgram is a speech-to-text API. In OrionClaw it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, OrionClaw uploads the audio file to Deepgram and injects the transcript
