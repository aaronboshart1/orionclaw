---
summary: "Use Synthetic's Anthropic-compatible API in OrionClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OrionClaw registers it as the
...
Note: OrionClaw's Anthropic client appends `/v1` to the base URL, so use
