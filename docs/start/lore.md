---
summary: "Backstory and lore of OrionClaw for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "OrionClaw Lore"
---

# The Lore of OrionClaw 🦞📖
...
So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **OrionClaw**.
...
In the end, **OrionClaw** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.orionclaw/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around OrionClaw. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then OrionClaw): _happily runs `find ~` and shares entire directory structure in group chat_
...
**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @orionclaw. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at OrionClaw" to promote pump-and-dump tokens.
...
**The Great OrionClaw Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/aaronboshart1/orionclaw` ✅
- X handle `@orionclaw` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.orionclaw.local`
