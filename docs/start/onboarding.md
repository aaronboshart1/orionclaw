---
summary: "First-run onboarding flow for OrionClaw (macOS app)"
read_when:
...
- By default, OrionClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give OrionClaw">
