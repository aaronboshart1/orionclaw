---
summary: "Overview of OrionClaw onboarding options and flows"
read_when:
...
OrionClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`orionclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the OrionClaw app when you want a fully guided setup on macOS. Docs:
