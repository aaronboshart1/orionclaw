---
summary: "macOS IPC architecture for OrionClaw app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# OrionClaw macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → OrionClaw.app → local execution.
