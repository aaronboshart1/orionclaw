...
- Same path: run the app from a fixed location (for OrionClaw, `dist/OrionClaw.app`).
...
Workaround: move files into the OrionClaw workspace (`~/.orionclaw/workspace`) if you want to avoid per-folder grants.
