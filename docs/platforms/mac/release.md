---
summary: "OrionClaw macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
  - Cutting or validating a OrionClaw macOS release
  - Updating the Sparkle appcast or feed assets
title: "macOS Release"
---

# OrionClaw macOS release (Sparkle)
...
ditto -c -k --sequesterRsrc --keepParent dist/OrionClaw.app dist/OrionClaw-2026.3.2.zip

# Optional: also build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/OrionClaw.app dist/OrionClaw-2026.3.2.dmg
...
ditto -c -k --keepParent apps/macos/.build/release/OrionClaw.app.dSYM dist/OrionClaw-2026.3.2.dSYM.zip
```
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/OrionClaw-2026.3.2.zip https://raw.githubusercontent.com/openclaw/openclaw/main/appcast.xml
```

Generates HTML release notes from `CHANGELOG.md` (via [`scripts/changelog-to-html.sh`](https://github.com/aaronboshart1/orionclaw/blob/main/scripts/changelog-to-html.sh)) and embeds them in the appcast entry.
Commit the updated `appcast.xml` alongside the release assets (zip + dSYM) when publishing.

## Publish & verify

- Upload `OrionClaw-2026.3.2.zip` (and `OrionClaw-2026.3.2.dSYM.zip`) to the GitHub release for tag `v2026.3.2`.
