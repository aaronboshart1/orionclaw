...
- Install via CLI: `orionclaw plugins install @orionclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `orionclaw plugins install ./extensions/zalo`
   - From npm (if published): `orionclaw plugins install @orionclaw/zalo`
...
- Approve via:
  - `orionclaw pairing list zalo`
  - `orionclaw pairing approve zalo <CODE>`
...
- Example: `orionclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `orionclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `orionclaw logs --follow`
