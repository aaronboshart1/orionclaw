...
read_when:
  - You want OrionClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OrionClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`orionclaw onboard`) and `orionclaw channels add` list optional channel plugins.
...
```bash
openclaw plugins install @orionclaw/nostr
```
