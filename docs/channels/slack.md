...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OrionClaw HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `orionclaw pairing approve slack <code>`.
...
OrionClaw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OrionClaw falls back to normal delivery for remaining payloads.
