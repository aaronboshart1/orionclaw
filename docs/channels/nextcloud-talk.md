...
```bash
openclaw plugins install @orionclaw/nextcloud-talk
```
...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "OrionClaw" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `orionclaw pairing list nextcloud-talk`
  - `orionclaw pairing approve nextcloud-talk <CODE>`
