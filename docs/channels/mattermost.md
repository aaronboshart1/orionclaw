---
summary: "Mattermost bot setup and OrionClaw config"
read_when:
...
4. Configure OrionClaw and start the gateway.
...
Use these target formats with `orionclaw message send` or cron/webhooks:
