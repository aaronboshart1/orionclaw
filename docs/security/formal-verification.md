...
summary: Machine-checked security models for OrionClaw’s highest-risk paths.
read_when:
...
This page tracks OrionClaw’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that OrionClaw enforces its
...
**What this is not (yet):** a proof that “OrionClaw is secure in all respects” or that the full TypeScript implementation is correct.
